...
export default {
    ...
    methods: {
        showBags(bagid, sellerName, ticketName) {
            //  http://127.0.0.1:8000/client/branch/7/NAME_Canada_Co./NAME_Canada_Co_Event_2022/event_bags/inside_bag/all_tickets?event_id=7&event_id=741&event_id=Zennon
            this.$router.push({
                path:
                    "/client/branch/" +
                    this.unitId +
