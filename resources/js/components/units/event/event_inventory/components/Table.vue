                    ...
                    <tr v-for="i in getData" :key="i.name">
                        <td>
                            <v-btn
                                ...
                                "
                            >
                                <u class="text-blue"> {{ i.ticket_number }}</u>
                            </v-btn>
                        </td>
                        <td>{{ i.ticket_name }}</td>
                        ...
                        <td>{{ i.ticket_date }}</td>
                        <td>
                            <ModalEdit :editId="i.ee_ticket_id" />
                        </td>
                        <!-- <td>
                            <v-btn
                                size="small"
                                ...
                                variant="outlined"
                                color="danger"
                                @click="deleteTickets(i.ee_ticket_id)"
                            >
...
export default {
    ...
    methods: {
        ...
        mount() {
            ...
            axios
                .get("/api/get_all_ticket/" + [this.unitId, this.eventId])
                .then((res) => {
                    this.getData = Object.values(res.data.status);
                    this.getData2 = Object.values(res.data.status);

                    let urls = [
                        "/api/get_all_ticket/" + [this.unitId, this.eventId],
                    ];
