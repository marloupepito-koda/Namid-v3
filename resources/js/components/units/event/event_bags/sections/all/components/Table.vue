            ...
            <v-table density="compact">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" v-if="access7 === 'On'">
                            Return
                        </th>
                        <th class="text-center" v-if="access9 === 'On'">
                            Edit
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="i in getData" :key="i.name">
                        ...
                        <td class="text-center" v-if="access7 === 'On'">
                            <v-btn
                                size="small"
                                variant="outlined"
                                large
                        ...
                        <td class="text-center" v-if="access9 === 'On'">
                            <EditModal
                                :editId="i.id"
...
export default {
    mounted() {
        this.mount();
        this.access7 = JSON.parse(localStorage.getItem("access")).access7;
        this.access9 = JSON.parse(localStorage.getItem("access")).access9;
    },
    components: {
        Modal,
        EditModal,
            ...
            axios
                ...
                .then((res) => {
                    ...
                    caches.open("static_cache").then((cache) => {
                        cache.addAll(urlsBagAPI).then(() => {
                            console.log("Data cached ");
                        });
                    });

                    this.getData = Object.values(res.data.status.data);
                    this.getData2 = Object.values(res.data.status.data);
