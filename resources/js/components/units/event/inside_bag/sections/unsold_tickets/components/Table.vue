            ...
            <table class="table table-sm">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" v-if="access11 === 'On'">
                            EDIT
                        </th>
                        <th class="text-center" v-if="access10 === 'On'">
                            SOLD
                        </th>
                    </tr>
                </thead>
...
export default {
    ...
    mounted() {
        this.access10 = JSON.parse(localStorage.getItem("access")).access10;
        this.access11 = JSON.parse(localStorage.getItem("access")).access11;
        this.mount();
    },
    data: () => ({
        access10: "",
        ...
        mount() {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    this.getData = res.data.status2;
                    this.getData2 = res.data.status2;
                    this.load = false;
                });
